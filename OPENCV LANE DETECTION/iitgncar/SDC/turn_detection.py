...
from .bezier_mine2 import bezier_coordinates
import PIL
...
def lane_separation(mask,img):
    ...
    turn=bezier_coordinates(coordinates_left,coordinates_right,left_lane,10,img)
    # print(turn)
    # print(coordinates_left)
    return turn,left_lane,right_lane,coordinates_left,coordinates_right
...
def floodfill(image):
    ...
    # try:
    turn,left_lane,right_lane,coordinates_left,coordinates_right=lane_separation(mask,image)
